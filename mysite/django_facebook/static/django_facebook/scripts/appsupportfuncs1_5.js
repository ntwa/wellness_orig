...
function appendTeamToGarden(box){
	...
	if(current_garden=="Nothing");
	 ...
	 var posn=parseInt(box.substr(3,box.length));
	  ...
	  var str=teams[posn];
           event_owner=str;//specify the owner of the displayed event
     str=str+":#";
     var rank="";
     var tie="";
...
//$('.swiper-container').removeClass('gardenbg1').addClass('gardenbg2');
         // $('.swiper-container').removeClass('gardenbg2').addClass('gardenbg1');
          $(".swiper-container[id='container1']").removeClass('gardenbg2').addClass('gardenbg1');
         // $(".swiper-container[id='container1']").removeClass('aquariumbg1').addClass('gardenbg1');
...
if((date_selected_garden===undefined) || (date_selected_garden==='Click Here!!'))
 ...
 date_of_display=$("#datepicker2garden").val();
 date_of_display=formatDate(date_of_display); 

 }
else
   {
   date_of_display=$("#datepickergarden").val();
...
function registerEvent(event_url,event_object)
{
//alert(event_url+"--"+event_object+"--"+event_owner+"--"+date_of_display);

var jsonObjects= {Points:pointsscored,ClicksCounter:clickscounter,EventUrl:event_url,EventObject:event_object,ObjectOwner:event_owner,DateDisplayed:date_of_display};
//var jsonObjects={Points:pointsscored,ClicksCounter:clickscounter,"EventObject":"Aquarium","EventUrl":"http://ict4d01.cs.uct.ac.za/","DateDisplayed":"22nd September","ObjectOwner":"8"}

jQuery.ajax({
          url: "http://ict4d01.cs.uct.ac.za/wellness/facebook/dataupdate/SN/",
      type: "POST",
          cache: false,
      contentType: "application/json",
      data: JSON.stringify(jsonObjects),
...
function aquariumEventDetector(){

registerEvent(fblike_url,"Aquarium");

         

}
function gardenEventDetector(){

registerEvent(fblike_url,"Garden");
...
{             
            ...
            //  alert(limit);
              ...
              var displayed_box="#container2 > .swiper-wrapper > .swiper-slide-active > ";
             ...
             comment_url=comment_url+selected_beneficiary_id;
             //comment_url=comment_url+date_of_display;
             comment_url=comment_url+"/";
...
fblike_url=fblike_url+"/fishtank/";
            fblike_url=fblike_url+selected_beneficiary_id;
            //fblike_url=fblike_url+date_of_display;
            fblike_url=fblike_url+"/";
...
//$('.swiper-container').removeClass('aquariumbg1').addClass('aquariumbg2');
          ...
          //$('.swiper-container').removeClass('gardenbg1').addClass('gardenbg1');
           $(".swiper-container[id='container2']").removeClass('aquariumbg1').addClass('aquariumbg2');
...
previous_day_displayed_scoretank=selectedvalue;
...
if((date_selected_aquarium===undefined) || (date_selected_aquarium==='Click Here!!'))
  { date_selected_aquarium="Today";
    date_of_display=$("#datepicker2scoretank").val();
    date_of_display=formatDate(date_of_display);

  }
else
   {
   date_of_display=$("#datepickerscoretank").val();

   }
$("#aquariumheader").html('');
$("#aquariumheader").append(""+"Fitness Aquarium. Date:"+date_selected_aquarium+"");
...
jQuery.ajax({
      ...
      success: function(result) {
         ...
         $(".swiper-container[id='container2']").removeClass('aquariumbg2').addClass('aquariumbg1');
